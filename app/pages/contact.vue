            ...
            <address class="space-y-8 relative z-10 text-left not-italic">
              ...
              <div v-if="hotel.phone" class="flex items-center gap-5 group/item">
                ...
                <div class="flex flex-col">
                  <span class="text-[9px] font-black tracking-[0.3em] text-slate-500 mb-1 uppercase italic">{{ t('contact.phone_label') }}</span>
              ...
              <div v-if="hotel.email" class="flex items-center gap-5 group/item">
                ...
                <div class="flex flex-col">
                  <span class="text-[9px] font-black tracking-[0.3em] text-slate-500 mb-1 uppercase italic">{{ t('contact.email_label') }}</span>
              ...
              <div v-if="hotel.address" class="flex items-start gap-5 group/item">
                ...
                <div class="flex flex-col">
                  <span class="text-[9px] font-black tracking-[0.3em] text-slate-500 mb-1 uppercase italic">{{ t('contact.address_label') }}</span>
