  ...
  <footer class="relative bg-hotel-slate pt-20 pb-10 px-6 overflow-hidden text-white/80 font-sans">
    ...
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-20 pb-16 border-b border-white/5">
        ...
        <div class="lg:col-span-4 space-y-8 text-center lg:text-left">
          <div class="space-y-4">
            ...
            <p class="text-[10px] md:text-[11px] font-bold tracking-[0.4em] uppercase text-hotel-gold/60 leading-relaxed">
              {{ t('footer.motto') }}
            </p>
          </div>
        ...
        <div class="lg:col-span-3 space-y-10 text-center lg:text-left pt-2">
          <div class="space-y-3">
            <span class="block text-[9px] font-black uppercase tracking-[0.3em] text-white/30 italic">{{ t('booking.rezervation') }}</span>
          ...
          <div class="space-y-3">
            <span class="block text-[9px] font-black uppercase tracking-[0.3em] text-white/30 italic">{{ t('contact.location') }}</span>
      ...
      <div class="pt-10 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div class="text-[9px] font-bold uppercase tracking-[0.2em] text-white/60">
