...
<template>
  <section
    class="relative min-h-screen w-full flex items-center justify-center bg-hotel-slate text-white overflow-hidden"
    aria-label="Cemal Alaçatı Hero"
  >
    <div
      class="absolute inset-0 z-10 bg-gradient-to-t from-hotel-slate/90 via-hotel-slate/30 to-black/50 pointer-events-none"
      aria-hidden="true"
    />
    ...
    <div class="relative z-20 text-center px-6 max-w-4xl">
      ...
      <p class="text-white font-medium text-sm md:text-lg tracking-wide max-w-lg mx-auto italic leading-relaxed drop-shadow-md">
        {{ $t('hero.subtitle') }}
      </p>
      ...
      <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <a :href="whatsappUrl" target="_blank" rel="noopener noreferrer" class="cta-btn-outline" aria-label="WhatsApp ile İletişime Geçin">
...
.cta-btn-gold {
  @apply bg-hotel-gold text-hotel-slate px-10 py-3.5 rounded-full text-[11px] 
