          ...
          <div class="lg:sticky lg:top-28 space-y-12">
            ...
            <header class="space-y-6">
              <div class="flex items-center gap-3">
                ...
                <span class="text-hotel-gold tracking-[0.4em] uppercase text-[10px] font-bold block italic opacity-90">
              ...
              >
                ...
                <div class="flex items-baseline gap-4">
                  ...
                  <div class="flex flex-col">
                    ...
                    <span class="text-[8px] text-hotel-slate/80 font-bold uppercase tracking-[0.2em] mt-1">
              ...
              <blockquote class="m-0 h-full flex flex-col justify-between">
                <div>
                  <div class="flex justify-between items-center mb-10">
                    ...
                    <time :datetime="comment.date" class="text-[9px] text-hotel-slate/60 uppercase tracking-[0.25em] font-black">
                      {{ comment.date }}
                    </time>
                  </div>
                  ...
                  <p class="text-hotel-slate/80 text-[16px] leading-[1.8] font-serif italic line-clamp-6">
                    {{ comment.text }}
                  </p>
                </div>
...
/* will-change: GPU katmanı önceden aktive → compositor animasyonu */
:deep(.group\/card) {
