  ...
  <section class="py-20 md:py-32 overflow-hidden bg-[#fcfbf7]">
    ...
    <header class="max-w-4xl mx-auto text-center mb-16 md:mb-24 px-6" data-aos="fade-up">
      <div class="flex items-center justify-center gap-3 mb-4">
        ...
        <span class="text-[10px] font-bold tracking-[0.5em] uppercase text-hotel-gold/80">
        ...
        <div class="w-full md:flex-1 space-y-8 text-left" data-aos="fade-up" :data-aos-delay="200">
          <div class="space-y-4">
            <div class="flex items-center gap-4">
              <span class="text-hotel-gold text-[10px] font-black tracking-[0.3em] uppercase opacity-80">
                {{ room.no }} / {{ room.cat }}
              </span>
          ...
          <div class="grid grid-cols-2 gap-y-4 gap-x-6 pt-8 border-t border-slate-100">
            ...
            >
              ...
              <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400 group-hover/feat:text-hotel-slate transition-colors">
